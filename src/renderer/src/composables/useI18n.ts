...
const messages = {
  zh: {
    ...
    about: 'OpenSerial - KiraDana v1.0.1',
    statusConnected: '已连接',
    ...
    reconnectInterval: '间隔(ms)',
    autoNewline: '自动换行符',
    newlineNone: '无',
    newlineCrlf: 'CR+LF',
    newlineLf: 'LF',
    autoReconnecting: '自动重连中...',
    reconnectSuccess: '重连成功',
    reconnectFailed: '重连失败，已重试',
    times: '次'
  },
  en: {
    ...
    rx: 'RX',
    tx: 'TX',
    stopReceiving: 'Stop RX',
    resumeReceiving: 'Resume RX',
    search: 'Search...',
    filterAll: 'All',
    filterReceive: 'RX Only',
    filterSend: 'TX Only',
    autoReconnect: 'Auto Reconnect',
    reconnectRetries: 'Retries',
    reconnectInterval: 'Interval(ms)',
    autoNewline: 'Auto Newline',
    newlineNone: 'None',
    newlineCrlf: 'CR+LF',
    newlineLf: 'LF',
    autoReconnecting: 'Reconnecting...',
    reconnectSuccess: 'Reconnect successful',
    reconnectFailed: 'Reconnect failed after',
    times: ' times'
  }
}
